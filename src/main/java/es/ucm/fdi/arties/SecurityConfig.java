	...
	protected void configure(HttpSecurity http) throws Exception {
	    http
			...
			.antMatchers("/css/**", "/js/**", "/img/**", "/", "/error", "/signup", "/courses", "/seeCourse", "/items/listToLoan", "/lessons/lessonsToBook").permitAll()
				...
				.antMatchers("/lessons/myBookingLessons", "/lessons/bookLesson", "/lessons/getDaysOfLesson", "/lessons/bookLessonSession", "/lessons/cancelBookSession").hasAnyRole("USER", "ADMIN", "STAFF")
