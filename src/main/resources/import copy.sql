...
INSERT INTO ITEM(id, name, description, quantity, max_Loan)
VALUES (1,'pesa 5kg', 'Una pequeña pesa para principiantes', 10, 2);

INSERT INTO ITEM(id, name, description, quantity, max_Loan)
VALUES (2,'pesa 10kg', 'Una pesa para niveles intermedios', 8, 2);

INSERT INTO ITEM(id, name, description, quantity, max_Loan)
VALUES (3,'pesa 15kg', 'Una pesa para tonificar', 6, 2);

INSERT INTO ITEM(id, name, description, quantity, max_Loan)
VALUES (4,'pesa 20kg', 'Una pesa para musculacion', 5, 2);

INSERT INTO ITEM(id, name, description, quantity, max_Loan)
VALUES (5,'bicicleta basica', 'Una bicicleta basica ideal para principiantes y uso por ciudad', 6, 1);

INSERT INTO ITEM(id, name, description, quantity, max_Loan)
VALUES (6,'bicicleta montaña', 'Una bicicleta perfecta para rutas por el campo', 4, 1);
